                    ...
                    if ((lineLength > 2) &&
                        ...
                        if ((recID.equalsIgnoreCase("EM")) &&
                            ...
                            if ((startPos > 0) && (endPos > 0) && (endPos > startPos)) {
                                EMDRec.docID = oneLine.substring(startPos, (endPos - startPos));
                                ...
                                endPos = StringUtils.searchStringOccur(oneLine,
                                    ";", 29);
                                if ((startPos > 0) && (endPos > 0) && (endPos > startPos)) {
                                    EMDRec.sellingFareAmount = oneLine.substring(startPos, (endPos - startPos))
                                ...
                                endPos = StringUtils.searchStringOccur(oneLine,
                                    ";", 34);
                                if ((startPos > 0) && (endPos > 0) && (endPos > startPos)) {
                                    EMDRec.remainingTax = oneLine.substring(startPos, (endPos - startPos))
                                            .replaceAll("[A-Z\\-]", "").replaceAll("\\s+", "");
                                } else {
                                    EMDRec.remainingTax = "";
                                }
                                ...
                                application.log.finest("EMDRecs is " + EMDRecs.toString());
                            }
                        }
                    } // not within the list
                } // end of while
            ...
            for (Enumeration recData = fileRecs.elements(); recData
                ...
                while (recData.hasMoreElements() &&
                    ...
                    // JR added length > 10 to ignore processing for record like eg : FPNONREF, FPNONREFAGT
                        ...
                        recTicketNo = tktRecord.substring(dashPos + 1, endPos - (dashPos + 1));
                        
                        // Update associated EMD record in EMDRecs
                        // first get the document id
                        startPos = StringUtils.searchStringOccur(
                            tktRecord, ";", 2);
                        tktDocID = tktRecord.substring(startPos);
