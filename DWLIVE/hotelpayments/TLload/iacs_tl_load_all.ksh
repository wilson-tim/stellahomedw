...
case $ORACLE_SID in
   ...
   DWL) java_conn="jdbc:oracle:thin:@p-gs2-ora-01:1525:dwl";;
esac
...
if [[ -s $iacs_path/errorfile.err ]] | [[ $grep_status -eq 0 ]] then
 ...
 mailx -s "DWHSE side : ERRORS in Travelink booking load into iacs datawarehouse" debbie.saunders@firstchoice.co.uk < /home/dw/DWLIVE/hotelpayments/TLload/mail.lst 
 mailx -s "DWHSE side : ERRORS in Travelink booking load into iacs datawarehouse" henry.bellenger@firstchoice.co.uk < /home/dw/DWLIVE/hotelpayments/TLload/mail.lst
 mailx -s "DWHSE side : ERRORS in Travelink booking load into iacs datawarehouse" jyoti.renganathan@tuispecialist.com < /home/dw/DWLIVE/hotelpayments/TLload/mail.lst 
 mailx -s "DWHSE side : ERRORS in Travelink booking load into iacs datawarehouse" mat.cottrell@tuispecialist.com < /home/dw/DWLIVE/hotelpayments/TLload/mail.lst 
