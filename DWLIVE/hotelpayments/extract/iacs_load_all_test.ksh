...
# 30/09/05    PB  Original bkgload.sql now borken down into packaged procedures/functions
#
...
# 30/09/05 PB Run procedures/functions via new sql in booking_load.sql instead of bkgload.sql
#sqlplus  dw/dbp @$iacs_path/bkgload >> $f_log_path/iacsload$today_d.log 
sqlplus dw/dbp @$iacs_path/booking_load.sql >> $f_log_path/iacsload$today_d.log
