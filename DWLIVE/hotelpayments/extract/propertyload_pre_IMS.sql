...
-- 2.6 Leigh       03/03/04     Tune again - add hint back in !
...
SELECT   /*+ ORDERED INDEX(a) INDEX(c) */ c.season_type||substr(c.season_year,3,2) season,
        ...
        and (c.season_year > '1999' or (c.season_year = '1999' and c.season_type = 'W'))
