...
/*
  old query -- too slow! too many rows produced by using accom_correlation 
...
FOR c1 IN maincursor LOOP
	...
	/* aded gateway code LA0206 */
        INSERT INTO iacs.leigh_property
                (PROPERTY_NUM               ,
	...
	DELETE FROM iacs.leigh_otop_property
 	...
 	v_statement :=111;
        ...
        FOR o1 in otop_prop(v_property_num) LOOP
                ...
                BEGIN
                        ...
                        INSERT INTO iacs.leigh_otop_property
                                (otop_accom_code,
                                season,
                                property_num)
                        VALUES
                        ...
                        WHEN DUP_VAL_ON_INDEX THEN
                                ...
                                UPDATE iacs.leigh_otop_property
